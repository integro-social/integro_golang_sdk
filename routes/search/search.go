...
func Message(__c *__client.Client, __query search.MessageSearchQuery) ([]domain.MessageSearchHit, error) {
	__path := "/search/message"
	return __client.Request[[]domain.MessageSearchHit](__c, "GET", __path, __query, nil)
}
